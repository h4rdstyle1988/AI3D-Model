...
def atomic_json(path: Path, payload: object) -> None:
    """Write a JSON report atomically without importing the mesh/CUDA stack."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--orientation",
        default="source +Y mapped to slicer +Z by --rotate-x 90; --ensure-on-bed; --arrange 1",
        help="Human-readable orientation evidence for this specific slice",
    )
    parser.add_argument("--filament", default="Anycubic PLA @Anycubic Kobra S1 0.4 nozzle")
