#!/usr/bin/env python3
"""Independent validation for v003-r01 with a 50-mm taller vertical leg."""
...
def main() -> int:
    ...
    report = {
        "schema": "ai3d.benchmark-b.wischtuchhalter.gate-report.v3",
        "candidate": {
            "id": candidate,
    ...
    (directory / "VALIDATION-REPORT.md").write_text(
        ...
        "Gegenüber v002-r01 wurde ausschließlich der gerade senkrechte Abschnitt oberhalb des Zapfens um **50,00 mm** verlängert. Zapfen, Passung, Ausladung, Querschnitt, Radien und Endanschlag bleiben unverändert.\n\n"
